...
1. Open `D:\Work\Games\SeniorDialer` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `SeniorDialerEngine.kt` (tube pour logic) and update the game board UI component.
