#!/usr/bin/env python3
"""Generate SeniorDialer Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\SeniorDialer")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "seniordialer"
TEST = APP / "src" / "test" / "java" / "com" / "seniordialer"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "seniordialer"
...
android {
    namespace = "com.seniordialer"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.seniordialer.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.seniordialer.data.** { *; }
-keep class com.seniordialer.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "seniordialer-game",
    "storage_bucket": "seniordialer-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.seniordialer.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating SeniorDialer project files...")
